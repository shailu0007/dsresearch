        ...
        <div className="finance">
            ...
            <div className="finance-left">
                <div className="finance-content">
                    ...
                    <p style={{ textAlign: 'justify' }}><strong>D.S Researech Investment Advisors</strong>&nbsp;is an SEBI registered one of the leading Stock Advisory Company in Stock and Commodity Market. Our strong hold in providing the most accurate Tips makes us stand apart from our competitors.<br />
                        <strong>D.S Researech investment Advisors</strong> is equipped with a team of the best and most experienced professionals who work with full devotion towards benefitting customers and helping them and their capital achieve new heights. Our analysis is solely based on the economic news and deep technical analysis done by our experts. We dedicatedly work for benefit of our personal and commercial trading clients by providing them best tips and information. We Provide all services through SMS and Instant Messenger. Our research is based around these services:</p>
