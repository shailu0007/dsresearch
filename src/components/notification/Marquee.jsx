...
const Marquee = () => {
  return (
    ...
    >
      Kindly Note it “D.S Researech Investment Researcher(SEBI Reg.No.INH000017824)” do not Provide any Profit
      ...
      any of Our Services”.We do not provide any account opening or Dmat services.D.S Researech neither provide portfolio
