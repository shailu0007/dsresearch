...
const Marquee = () => {
  return (
    ...
    >
      Kindly Note it “Eminent Investment Advisors(SEBI Reg.No.INA000010104)” do not Provide any Profit 
      ...
      any of Our Services”.We do not provide any account opening or Dmat services.Eminent Research neither provide portfolio 
