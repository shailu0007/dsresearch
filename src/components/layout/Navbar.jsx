          ...
          <ul className="nav navbar-nav">
            ...
            <li className="dropdown">
              ...
              <ul className="dropdown-menu">
                ...
                <li className="hover01">
                  <NavLink to="#" className="catnav" id="catnav5">
                    Stock Future Services
                  </NavLink>
                  <ul className="hoverShow hoverShow01">
                    <li>
                      <NavLink to="/services/stock-future-signature">
                        Stock Future Signature
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="/services/stock-future-positional">
                        Stock Future Positional
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="/services/stock-future-regular">
                ...
                <li className="hover01">
                  <NavLink to="#" className="catnav" id="catnav6">
                    Nifty Services
                  </NavLink>
                  <ul className="hoverShow hoverShow01">
                    <li>
                      <NavLink to="/services/nifty-support">
                        Nifty Support
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="/services/index-platinum">
                        Index Platinum
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="/services/index-expiry-special">
                ...
                <li className="hover01">
                  <NavLink to="#" className="catnav" id="catnav8">
                    Stock Option Services
                  </NavLink>
                  <ul className="hoverShow hoverShow01">
                    <li>
                      <NavLink to="/services/stock-option-regular">
                        Stock Option Regular
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="/services/stock-option-signature">
                ...
                <li className="hover01">
                  <NavLink to="#" className="catnav" id="catnav9">
                    Commodity Services
                  </NavLink>
                  <ul className="hoverShow hoverShow01">
                    <li>
                      <NavLink to="/services/all-mcx">ALL MCX</NavLink>
                    </li>
                    <li>
                      <NavLink to="/services/all-agri-product">
                        All Agri Product
                      </NavLink>
                    </li>
                  </ul>
                ...
                <li className="hover01">
                  <NavLink to="#" className="catnav" id="catnav11">
                    Journal Services
                  </NavLink>
                  <ul className="hoverShow hoverShow01">
                    <li>
                      <NavLink to="/services/journal-services">
                        Journal Services
                      </NavLink>
                    </li>
                  </ul>
            ...
            <li>
              <NavLink to="/pastperformance">Past Performance</NavLink>
            </li>
            <li>
            ...
            <li className="dropdown">
              ...
              <ul className="dropdown-menu">
                ...
                <li>
                  <NavLink to="/kyc">KYC Form</NavLink>
                </li>
                <li>
                ...
                <li>
                  <NavLink to="/investor-charter">Investor Charter</NavLink>
                </li>
              </ul>
            </li>
          </ul>
